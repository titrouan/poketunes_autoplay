...
public class MusicFadesManager {
    ...
    private void onClientTick(MinecraftClient client) {
        if (isFadingIn && currentSoundInstance != null) {
            ...
            //System.out.println("[PokeTunes AutoPlay] Increase input fade-in counter : " + fadeInCounter);
            ...
            if (fadeInCounter >= fadeInTicks) {
                ...
                if (currentSoundInstance instanceof VolumeAdjustable adjustable) {
                     ...
                     */
                    adjustable.poketunesautoplay$setVolume(targetVolumeSupplier);
                    //System.out.println("[PokeTunes AutoPlay] Fin du fondu d'entrée, volume cible = " + targetVolumeSupplier);
                    //System.out.println("[PokeTunes AutoPlay] End of fade-in, target volume = " + targetVolumeSupplier);
                }
                isFadingIn = false;
            } else {
                ...
                if (currentSoundInstance instanceof VolumeAdjustable adjustable) {
                    ...
                    //System.out.println("[PokeTunes AutoPlay] Tick " + fadeInCounter + ", actual volume = " + interpolatedVolume);
                }
            }
        }
    }
